...
export const fc_gye2fo = (option?: FrourioClientOption) => ({
  ...
  $build(req: Parameters<ReturnType<typeof methods>['$get']>[0] | null): [
    ...
    return [{ lowLevel: true, baseURL: option?.baseURL, dir: '/api/mw/admin/users', ...rest }, () => fc_gye2fo(option).$get(req)];
  },
  ...methods(option),
});
...
export const $fc_gye2fo = (option?: FrourioClientOption) => ({
  ...
  $build(req: Parameters<ReturnType<typeof methods>['$get']>[0] | null): [
    ...
    return [{ lowLevel: false, baseURL: option?.baseURL, dir: '/api/mw/admin/users', ...rest }, () => $fc_gye2fo(option).$get(req)];
  },
