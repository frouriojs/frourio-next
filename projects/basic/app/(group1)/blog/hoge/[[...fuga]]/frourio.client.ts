...
export const fc_14jcy50 = (option?: FrourioClientOption) => ({
  ...
  $build(req: Parameters<ReturnType<typeof methods>['$get']>[0] | null): [
    ...
    return [{ lowLevel: true, baseURL: option?.baseURL, dir: '/(group1)/blog/hoge/[[...fuga]]', ...rest }, () => fc_14jcy50(option).$get(req)];
  },
  ...methods(option),
});
...
export const $fc_14jcy50 = (option?: FrourioClientOption) => ({
  ...
  $build(req: Parameters<ReturnType<typeof methods>['$get']>[0] | null): [
    ...
    return [{ lowLevel: false, baseURL: option?.baseURL, dir: '/(group1)/blog/hoge/[[...fuga]]', ...rest }, () => $fc_14jcy50(option).$get(req)];
  },
