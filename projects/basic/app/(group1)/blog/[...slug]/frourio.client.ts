...
export const fc_er79ce = (option?: FrourioClientOption) => ({
  ...
  $build(req: Parameters<ReturnType<typeof methods>['$get']>[0] | null): [
    ...
    return [{ lowLevel: true, baseURL: option?.baseURL, dir: '/(group1)/blog/[...slug]', ...rest }, () => fc_er79ce(option).$get(req)];
  },
  ...methods(option),
});
...
export const $fc_er79ce = (option?: FrourioClientOption) => ({
  ...
  $build(req: Parameters<ReturnType<typeof methods>['$get']>[0] | null): [
    ...
    return [{ lowLevel: false, baseURL: option?.baseURL, dir: '/(group1)/blog/[...slug]', ...rest }, () => $fc_er79ce(option).$get(req)];
  },
